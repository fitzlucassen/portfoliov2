...
class Router
{
	 ...
	 * @return type
	 */
	private static function findPattern($pattern, $method = false)
	{ // method is for anonymous params
	...
	public static function getRoutes($key = null, $lang = null)
	{
		...
		return ($key === null) ? ((isset(self::$_routes[$lang])) ? self::$_routes[$lang] : array()) : ((isset(self::$_routes[$lang][$key])) ? self::$_routes[$lang][$key] : false);
	}
