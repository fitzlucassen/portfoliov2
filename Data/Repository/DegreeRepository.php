<?php 
	...
	class DegreeRepository {
		...
		public static function getAll($Connection){
			...
			$query = $qb->select()->from(array("degree"))->getQuery();
			try {
				$result = $Connection->SelectTable($query);
				$array = array();
				foreach ($result as $object){
					$o = new entities\Degree();
					$o->fillObject($object);
					$array[] = $o;
				}
				return $array;
		...
		public function delete($id) {
			$query = $this->_queryBuilder->delete("degree")
