<?php 
	...
	class CompanyRepository {
		...
		public static function getAll($Connection){
			...
			$query = $qb->select()->from(array("company"))->getQuery();
			try {
				$result = $Connection->SelectTable($query);
				$array = array();
				foreach ($result as $object){
					$o = new entities\Company();
					$o->fillObject($object);
					$array[] = $o;
				}
				return $array;
		...
		public function delete($id) {
			$query = $this->_queryBuilder->delete("company")
