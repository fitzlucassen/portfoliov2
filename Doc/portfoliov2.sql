...
--
-- Host: localhost
-- Generation Time: Nov 05, 2014 at 10:28 AM
...
--
-- Table structure for table `rewrittingurl`
--
...
--
-- Dumping data for table `rewrittingurl`
--
...
--
-- Table structure for table `routeurl`
--
...
--
-- Dumping data for table `routeurl`
--
...
--
-- Indexes for table `rewrittingurl`
--
ALTER TABLE `rewrittingurl`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `routeurl`
--
...
--
-- AUTO_INCREMENT for table `rewrittingurl`
--
ALTER TABLE `rewrittingurl`
MODIFY `id` tinyint(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `routeurl`
--
ALTER TABLE `routeurl`
MODIFY `id` tinyint(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
